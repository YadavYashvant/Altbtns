...
import com.yashvant.altbtns.utils.thousand
import com.yashvant.altbtns.utils.twenty
...
fun AltBtn(
    ...
    Box(
        ...
        Button(
            ...
            enabled = enabled && buttonState != AltBtnState.LOADING,
            elevation = elevation,
            shape = RoundedCornerShape(altBtnAnimateIntAsState(cornerRadiusValue, speedMillis)),
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            leftImagePainter?.let {
                Icon(
                    ...
                    modifier = Modifier
                        .graphicsLayer(
                            alpha = altBtnAnimateFloatAsState(
            ...
            val alphaText = altBtnAnimateFloatAsState(
                targetValue = iconAlphaValue,
                durationMillis = speedMillis
            )
            if (text != null) {
        ...
        PrintLoadingBar(
            type = type,
            progressAlpha = altBtnAnimateFloatAsState(progressAlphaValue, speedMillis),
